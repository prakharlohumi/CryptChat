...
public class serverIP extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        {
            JOptionPane.showMessageDialog(new JFrame(),"Enter a Valid IP Address!");
        }
        else
        {
            IP=ip.getText().trim();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(serverIP.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
